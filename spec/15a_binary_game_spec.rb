...
describe BinaryGame do
  ...
  describe '#player_input' do
    ...
    context 'when user inputs an incorrect value once, then a valid input' do
      before do
        allow(game_input).to receive(:gets).and_return('f', '2')
      end
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        allow(game_input).to receive(:gets).and_return('f', 'g', '3')
      end
  ...
  describe '#verify_input' do
    ...
    context 'when given a valid input as argument' do
      it 'returns valid input' do
        ...
        expect(game_input.verify_input(min, max, input)).to eq(3)
      end
    end
    ...
    context 'when given invalid input as argument' do
      it 'returns nil' do
        ...
        expect(game_input.verify_input(min, max, input)).to be nil
      end
    end
  end
  ...
  describe '#maximum_guesses' do
    ...
    context 'when game minimum and maximum is 100 and 600' do
      ...
      it 'returns 9' do
        expect(game_six_hundred.maximum_guesses).to eq(9)
      end
    end
  end
  ...
  describe '#display_turn_order' do
    ...
    subject(:binary_game) { described_class.new(1, 100, 70) }
    let(:binary_search) { instance_double(BinarySearch, min: 1, max: 100, answer: 70) }
    ...
    before do
      ...
      allow(binary_game).to receive(:display_guess)
    end
