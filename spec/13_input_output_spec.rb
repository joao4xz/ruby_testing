...
describe NumberGame do
  ...
  describe '#player_turn' do
    ...
    context 'when user inputs two incorrect values, then a valid input' do
      before do
        incorrect_values = ['d', 'b']
        valid_input = '8'
        allow(game_loop).to receive(:player_input).and_return(incorrect_values[0], incorrect_values[1], valid_input)
      end
  ...
  describe '#final_message' do
    ...
    context 'when count is 4 and over' do
      ...
      it 'outputs correct phrase' do
        ...
        expect { game_three.final_message }.to output(phrase).to_stdout
      end
    end
  end
end
